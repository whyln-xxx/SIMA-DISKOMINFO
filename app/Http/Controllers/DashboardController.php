...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $user = Auth::guard('peserta_magang')->user();
        ...
        $rekapPresensi = DB::table("presensi")
            ->selectRaw("COUNT(npm) as jml_kehadiran, SUM(IF (jam_masuk > '08:00',1,0)) as jml_terlambat")
            ->where('npm', $user->npm)
    ...
    public function indexAdmin()
    {
        ...
        $totalPesertaMagang = PesertaMagang::count();
        ...
        return view("admin.dashboard", compact("title", "totalPesertaMagang", "rekapPresensi", "rekapPengajuanPresensi"));
    }
}
